...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='MixStyle',
                        help='Name of the model (in ./models directory)')
    parser.add_argument('--source', type=str, default='GearFace20_2,GearFace20_3,GearFace20_4',
                        help='Source data, separated by "," (select specific conditions of the dataset with name_number, such as CWRU_0)')
    parser.add_argument('--target', type=str, default='GearFace20_1',
